namespace restaurant_service.Model
{
    public class RestaurantDTO
    {
        ...
        public RestaurantDTO(string id, string name, string address, string email, List<FoodDTO> menu, int verificationCode, bool accountActive, bool accountSuspended, int postal_code)
        {
            this.id = id;
            this.name = name;
